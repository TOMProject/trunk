...
public class CommonConvertUtils {
	...
	public static void convertCompanyToStation(Company company, StationInfo stationInfo) {
		Integer companyLevel = company.getCompanyLevel();
		if (companyLevel != null) {
			switch (company.getCompanyLevel()) {
			case 1:
				stationInfo.setCompanyId1(company.getCompanyId());
				break;
			case 2:
				stationInfo.setCompanyId2(company.getCompanyId());
				break;
			case 3:
				stationInfo.setCompanyId3(company.getCompanyId());
				break;
			default:
				stationInfo.setCompanyId3(company.getCompanyId());
				break;
